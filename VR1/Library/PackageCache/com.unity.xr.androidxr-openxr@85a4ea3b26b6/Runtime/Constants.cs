namespace UnityEngine.XR.OpenXR.Features.Android
{
    static class Constants
    {
        ...
        internal const string k_MajorMinorVersion = "1.3";
        ...
        internal static class DocsUrls
        {
            ...
            internal const string k_AndroidXRSupport = k_DocumentationFeatureBaseUrl + "androidxr-support.html";
            internal const string k_SceneMeshingUrl = k_DocumentationFeatureBaseUrl + "meshing.html";
        }
        ...
        internal static class OpenXRExtensions
        {
            ...
            internal const string k_XR_ANDROID_eye_tracking = "XR_ANDROID_eye_tracking";
            ...
            internal const string k_XR_ANDROID_face_tracking = "XR_ANDROID_face_tracking";
            internal const string k_XR_ANDROID_trackables_object = "XR_ANDROID_trackables_object";
            internal const string k_XR_ANDROID_scene_meshing = "XR_ANDROID_scene_meshing";
            internal const string k_XR_ANDROID_global_passthrough_dimming = "XR_ANDROID_global_passthrough_dimming";
        }
        ...
        internal static class Permissions
        {
            ...
            internal const string k_FaceTrackingPermission = "android.permission.FACE_TRACKING";
        }
    }
}
