...
namespace UnityEditor.XR.OpenXR.Features.Android
{
    static class AndroidXRProjectValidationRules
    {
        ...
        const AndroidSdkVersions k_MinSupportedSdkVersion = AndroidSdkVersions.AndroidApiLevel26;
        ...
        static void AddGlobalAndroidXRValidationRules()
        {
            ...
            BuildValidator.AddRules(BuildTargetGroup.Standalone, androidXRGlobalRules);
        }
