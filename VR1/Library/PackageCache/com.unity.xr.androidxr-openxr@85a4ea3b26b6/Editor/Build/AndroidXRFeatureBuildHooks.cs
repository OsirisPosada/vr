...
namespace UnityEditor.XR.OpenXR.Features.Android
{
    internal class AndroidXRFeatureBuildHooks : OpenXRFeatureBuildHooks
    {
        ...
        protected override bool bootConfigEntryRequired => true;
        public override Type featureType => typeof(AndroidXRSupportFeature);
        protected override void OnPreprocessBuildExt(BuildReport report) { }
        protected override void OnPostGenerateGradleAndroidProjectExt(string path) { }
        protected override void OnPostprocessBuildExt(BuildReport report) { }

        private static AndroidXRSupportFeature GetAndroidXRSupportFeature()
        {
            var featureGuids = AssetDatabase.FindAssets($"t:{nameof(AndroidXRSupportFeature)}");
        ...
        protected override void OnProcessBootConfigExt(BuildReport report, BootConfigBuilder builder)
        {
            ...
            var foveatedRenderingFeature = OpenXRSettings.ActiveBuildTargetInstance.GetFeature<FoveatedRenderingFeature>();

            // Update the boot config
            builder.SetBootConfigBoolean(kVulkanExtensionFragmentDensityMap, foveatedRenderingFeature != null && foveatedRenderingFeature.enabled);
