...
> [!WARNING]
> The XREAL Aura device does not support face tracking. A software issue can cause your application to crash when face tracking is enabled on this device. A workaround is to turn off the **Android XR: AR Face** feature in your project's OpenXR settings.
>
> ![AndroidXR Faces](../images/xreal-workaround.png)
>
> Refer to [Enable Unity OpenXR: Android XR](xref:androidxr-openxr-project-setup#enable) for more information about Android XR settings.
...
Your user must calibrate face tracking before the face tracking subsystem can provide information about their face. To confirm the present face tracking calibration state, use the [TryGetIsFaceTrackingCalibrated](xref:UnityEngine.XR.OpenXR.Features.Android.AndroidOpenXRFaceSubsystem.TryGetIsFaceTrackingCalibrated*) API.

If your user has not calibrated face tracking, consider directing them to the operating system's face tracking calibration flow.
